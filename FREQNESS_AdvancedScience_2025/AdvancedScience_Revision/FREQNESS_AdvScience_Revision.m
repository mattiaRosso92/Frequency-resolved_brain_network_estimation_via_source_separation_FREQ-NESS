...
%%% SOURCE RECONSTRUCTION (WITH MAGNETOMETERS) FOR THE
%%% RESTING STATE FOR DATASET TSA2021
...
%% Replicate GENERALISED EIGENVECTOR DECOMPOSITION (GED) on LB2017 and TSA2021 datasets
...
%% Replicate GENERALISED EIGENVECTOR DECOMPOSITION (GED) with GRADIOMETERS on FREQNESS dataset
...
%% Replicate GENERALISED EIGENVECTOR DECOMPOSITION (GED) with MAGNETOMETERS AND SOURCE LEAKAGE CORRECTION on FREQNESS dataset
