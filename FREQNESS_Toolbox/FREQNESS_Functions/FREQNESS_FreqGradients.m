...
% For convenience, also keep the Hz-range explicitly
range2model = frex(idx_range2model);
...
title('X gradient - Group', 'FontSize', 18)
% Y
subplot(132), hold on 
...
ylabel('Frequency', 'FontSize', 18)
title('Y gradient - Group', 'FontSize', 18)
% Z
subplot(133), hold on
...
ylabel('Frequency', 'FontSize', 18)
title('Z gradient - Group', 'FontSize', 18)
...
if plot_all
    ...
    for subi = 1:nsubs
        ...
        xlabel(coordlabs{1}, 'FontSize', 18)
        ylabel('Frequency', 'FontSize', 18)
        title(sprintf('X gradient – subject %d', subi), 'FontSize', 18)
        ...
        xlabel(coordlabs{2}, 'FontSize', 18)
        ylabel('Frequency', 'FontSize', 18)
        title(sprintf('Y gradient – subject %d', subi), 'FontSize', 18)
        ...
        xlabel(coordlabs{3}, 'FontSize', 18)
        ylabel('Frequency', 'FontSize', 18)
        title(sprintf('Z gradient – subject %d', subi), 'FontSize', 18)
