function runNetworkEstimationProcess(jobFile)
%RUNNETWORKESTIMATIONPROCESS Execute a serialized core job in another MATLAB.
...
try
    report = freqnessgui.runNetworkEstimation( ...
        job.dataset,job.configuration,@publishProgress, ...
